---
title: "Running Pingora as a Daemon"
sidebarTitle: "Daemonization"
description: "How to run a Pingora server as a background daemon, drop privileges after bootstrap, and use pid_file to track the process."
---
