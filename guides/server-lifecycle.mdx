---
title: "Starting and Stopping a Pingora Server"
sidebarTitle: "Server Lifecycle"
description: "How to start, stop, and signal a Pingora server — including SIGINT fast shutdown, SIGTERM graceful shutdown, and SIGQUIT graceful upgrade."
---
