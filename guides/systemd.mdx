---
title: "Running Pingora Under systemd"
sidebarTitle: "systemd"
description: "Configure systemd service units to manage Pingora server lifecycle, including socket activation and graceful restart on binary update."
---
